/*******************************************************************************************************
 *
 * gama.common.util.RandomUtils.java, in plugin gama.core, is part of the source code of the GAMA modeling and
...
import gama.util.random.CellularAutomatonRNG;
import gama.util.random.GamaRNG;
import gama.util.random.JavaRNG;
import gama.util.random.MersenneTwisterRNG;
