...
/**
 * Provides a no-op implementation of an element processor. This implementation is provided to allow nested elements to
 * be ignored if they are not required.
 *
...
public class DummyElementProcessor extends BaseElementProcessor {
	 ...
	 */
	public DummyElementProcessor(final BaseElementProcessor parentProcessor) {
	...
	/**
	 * This implementation returns itself and increments an internal counter. The corresponding getParent method
	 * decrements the counter and when it reaches zero returns the true parent of this instance.
	 *
	 * @param uri
	 *            The element uri.
	 * @param localName
	...
	/**
	 * This implementation decrements an internal counter, if the counter reaches zero the true parent is returned, else
