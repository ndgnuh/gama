/*******************************************************************************************************
 *
 * ummisco.gama.display.opengl.OpenGL.java, in plugin ummisco.gama.display.opengl, is part of the source code of the
 ...
 *
 ********************************************************************************************************/
package ummisco.gama.display.opengl;
...
import ummisco.gama.display.opengl.renderer.caches.FontCache;
import ummisco.gama.display.opengl.renderer.caches.GeometryCache;
import ummisco.gama.display.opengl.renderer.caches.GeometryCache.BuiltInGeometry;
import ummisco.gama.display.opengl.renderer.caches.ITextureCache;
import ummisco.gama.display.opengl.renderer.caches.TextureCache2;
import ummisco.gama.display.opengl.renderer.helpers.AbstractRendererHelper;
import ummisco.gama.display.opengl.renderer.helpers.PickingHelper;
import ummisco.gama.display.opengl.scene.AbstractObject;
import ummisco.gama.display.opengl.scene.FieldDrawer;
import ummisco.gama.display.opengl.scene.GeometryDrawer;
import ummisco.gama.display.opengl.scene.ObjectDrawer;
import ummisco.gama.display.opengl.scene.ResourceDrawer;
import ummisco.gama.display.opengl.scene.StringDrawer;
...
public class OpenGL extends AbstractRendererHelper implements Tesselator {
	...
	public int getTextureId(final IGamaFile.Image file, final boolean useCache) {
	...
	public void cacheGeometry(final IGamaFile.Geom object) {
		geometryCache.process(object);
	}

	public Envelope3D getEnvelopeFor(final Object obj) {
		// Always return a copy (see #2829)
		if (obj instanceof IGamaFile.Geom)
			return Envelope3D.of(geometryCache.getEnvelope((IGamaFile.Geom) obj));
	...
	public void drawCachedGeometry(final IGamaFile.Geom file, final Color border) {
		if (file == null)
			return;
