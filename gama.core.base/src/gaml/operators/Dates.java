/*******************************************************************************************************
 *
 * gaml.operators.Dates.java, in plugin gama.core, is part of the source code of the GAMA modeling and
...
public class Dates {
	...
	public final static Pref<String> DATES_CUSTOM_FORMATTER = GamaPreferences.create("pref_date_custom_formatter",
			...
			.onChange((e) -> {
				try {
					FORMATTERS.put(CUSTOM_KEY, getFormatter(GAMA.getRuntimeScope(), StringUtils.toJavaString(e), null));
	...
	public static DateTimeFormatter getFormatter(final IScope scope, final String p, final String locale) {
