...
public class GamaRFile extends GamaFile<IMap, Object> {
	...
	@doc (
			...
			examples = { @example (
					...
					isExecutable = false) })
	public GamaRFile(final IScope scope, final String pathName) throws GamaRuntimeException {
	...
	public GamaRFile(final IScope scope, final String pathName, final IMap p) {
