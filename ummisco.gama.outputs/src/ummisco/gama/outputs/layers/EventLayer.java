/*******************************************************************************************************
 *
 * ummisco.gama.outputs.layers.EventLayer.java, in plugin msi.gama.core, is part of the source code of the GAMA modeling and
...
public class EventLayer extends AbstractLayer {
	...
	private class EventListener implements IEventLayerListener {
		 ...
		 * Method keyPressed()
		 *
		 * @see msi.gama.common.interfaces.outputs.IEventLayerListener#keyPressed(java.lang.Character)
		 */
		@Override
