...
public class GamlLabelProvider extends DefaultEObjectLabelProvider implements IGamlLabelProvider {
	...
	/**
	 * @see ummisco.gama.ui.interfaces.IGamlLabelProvider#getText(msi.gaml.compilation.ast.ISyntacticElement)
	 */
	@Override
	...
	/**
	 * @see ummisco.gama.ui.interfaces.IGamlLabelProvider#getImage(msi.gaml.compilation.ast.ISyntacticElement)
	 */
	@Override
