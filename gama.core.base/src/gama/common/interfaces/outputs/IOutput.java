/*******************************************************************************************************
 *
 * gama.outputs.IOutput.java, in plugin gama.core, is part of the source code of the GAMA modeling and
...
public interface IOutput extends ISymbol, IStepable, IScoped {
	...
	interface FileBased extends IOutput {

		File getFile();

		void doRefreshWriteAndClose(ParametersSet currentSolution, Object lastFitnessValue);

	}

	/**
	 * Interface for monitors, inspectors and browsers
	 *
	 * @author drogoul
	 *
	 */

	interface Monitor extends IOutput {
