/*******************************************************************************************************
 *
 * gama.ui.displays.opengl.renderer.caches.TextureCache2.java, in plugin gama.ui.displays.opengl, is part of the source code of
 ...
 *
 ********************************************************************************************************/
package gama.ui.displays.opengl.renderer.caches;
...
public class TextureCache2 implements ITextureCache {
	 ...
	 * (non-Javadoc)
	 *
	 * @see gama.ui.displays.opengl.renderer.caches.ITextureCache#initialize()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 *
	 * @see gama.ui.displays.opengl.renderer.caches.ITextureCache#deleteVolatileTextures()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 *
	 * @see gama.ui.displays.opengl.renderer.caches.ITextureCache#dispose()
	 */
	@Override
	public void dispose() {
	 ...
	 * (non-Javadoc)
	 *
	 * @see gama.ui.displays.opengl.renderer.caches.ITextureCache#processs(java.io.File)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 *
	 * @see gama.ui.displays.opengl.renderer.caches.ITextureCache#processUnloaded()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 *
	 * @see gama.ui.displays.opengl.renderer.caches.ITextureCache#getTexture(java.awt.image.BufferedImage)
	 */
	@Override
