/*******************************************************************************************************
 *
 * gaml.types.TypesManager.java, in plugin gama.core, is part of the source code of the GAMA modeling and
...
public class TypesManager implements IDescription.DescriptionVisitor<SpeciesDescription>, ITypesManager {
	 ...
	 * (non-Javadoc)
	 *
	 * @see gaml.types.ITypesManager#alias(java.lang.String, java.lang.String)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 *
	 * @see gaml.types.ITypesManager#addSpeciesType(gaml.descriptions. TypeDescription)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 *
	 * @see gaml.types.ITypesManager#init()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 *
	 * @see gaml.types.ITypesManager#containsType(java.lang.String)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 *
	 * @see gaml.types.ITypesManager#dispose()
	 */
	@Override
	public void dispose() {
		types.clear();
