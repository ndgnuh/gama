 ...
 *
 **********************************************************************************************/
package ummisco.gama.ui.reference;
...
public class TemplateReferenceMenu extends GamlReferenceMenu {
	...
	public void editTemplate(final String dataId) {
		...
		if (data == null) {
			data = new TemplatePersistenceData(
					new Template("", "", "ummisco.gama.gaml.Gaml.Model", editor.getSelectedText(), true), true,
					dataId);
		}
	...
	protected void openView() {
		try {
			WorkbenchHelper.getPage().showView("ummisco.gama.gaml.ui.templates");
	...
	/**
	 * @see ummisco.gama.gaml.ui.reference.GamlReferenceMenu#getImage()
	 */
	@Override
	...
	/**
	 * @see ummisco.gama.gaml.ui.reference.GamlReferenceMenu#getTitle()
	 */
	@Override
