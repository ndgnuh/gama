/*******************************************************************************************************
 *
 * gaml.statements.CreateFromNullDelegate.java, in plugin gama.core,
...
public class CreateFromNullDelegate implements ICreateDelegate {
	 ...
	 * @since 04-09-2012
	 * @see gama.common.interfaces.ICreateDelegate#createFrom(gama.runtime.scope.IScope, java.util.List, int,
	 *      java.lang.Object)
	 */
	@Override
