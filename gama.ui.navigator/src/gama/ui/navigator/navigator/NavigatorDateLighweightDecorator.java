/*********************************************************************************************
 *
 * 'NavigatorDateLighweightDecorator.java, in plugin gama.ui.base.navigator, is part of the source code of the GAMA
...
public class NavigatorDateLighweightDecorator implements ILightweightLabelDecorator {
	...
	static final public String ID = "gama.core.application.decorator";
