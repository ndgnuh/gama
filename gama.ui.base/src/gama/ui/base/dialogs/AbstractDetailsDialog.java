/*********************************************************************************************
 *
 * 'AbstractDetailsDialog.java, in plugin gama.ui.base.shared, is part of the source code of the GAMA modeling and
...
/**
 * An abstract dialog with a details section that can be shown or hidden by the user. Subclasses are responsible for
 * providing the content of the details section.
 */
public abstract class AbstractDetailsDialog extends Dialog {
	 ...
	 */
	protected AbstractDetailsDialog(final IShellProvider parentShell, final String title, final Image image,
