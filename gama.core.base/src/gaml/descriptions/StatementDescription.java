/*******************************************************************************************************
 *
 * gaml.descriptions.StatementDescription.java, in plugin gama.core, is part of the source code of the GAMA
...
import static gama.common.interfaces.IGamlIssue.GENERAL;
import static gama.common.interfaces.IGamlIssue.MISSING_NAME;
import static gama.common.interfaces.IGamlIssue.SHOULD_CAST;
import static gama.common.interfaces.IGamlIssue.UNKNOWN_ARGUMENT;
import static gaml.statements.DoStatement.DO_FACETS;
import static gaml.types.Types.NO_TYPE;
