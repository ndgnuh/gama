 ...
 *
 *
 * 'MDXSkill.java', in plugin 'irit.gama.extensions.database', is part of the source code of the GAMA modeling and
...
import irit.gama.extensions.database.mdx.MdxConnection;
import irit.gama.extensions.database.mdx.MdxUtils;
