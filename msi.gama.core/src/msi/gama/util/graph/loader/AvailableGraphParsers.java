/*******************************************************************************************************
 *
 * msi.gama.util.graph.loader.AvailableGraphParsers.java, in plugin msi.gama.core, is part of the source code of the
...
/**
 * Lists all the layouts available, independently of the underlying libraries. If you add a parser, add it there.
 *
...
public class AvailableGraphParsers {
	...
	/**
	 * Returns the list of all the names of loader declared. Typically required for interaction with users (like propose
	 * the list of all the possible loader, or search something passed by the user).
	 *
	 * @return
	 */
	...
	/**
	 * Returns a list of loaders declared, by ensuring that each loader is provided once only. So all the redondancies
	 * are removed. Typically used for automatic type detection.
	 *
	 * @return
	 */
	...
	private static Map<String, IGraphParser> name2singleton = new HashMap<>();

	public static IGraphParser getLoader(final IScope scope, final String name) {
