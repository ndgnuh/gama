		...
		(
			...
			lv_exp_0_0=ruleHeadlessExperiment
			{
				...
				set(
					...
					"exp",
					lv_exp_0_0,
					"ummisco.gama.Gaml.HeadlessExperiment");
				afterParserOrEnumRuleCall();
			}
		)
	)
			...
			(
				...
				lv_key_0_0=rule_ExperimentKey
				{
					...
					set(
						...
						"key",
						lv_key_0_0,
						"ummisco.gama.Gaml._ExperimentKey");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_key_0_0=rule_1Expr_Facets_BlockOrEnd_Key
				{
					...
					set(
						...
						"key",
						lv_key_0_0,
						"ummisco.gama.Gaml._1Expr_Facets_BlockOrEnd_Key");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_firstFacet_1_0=ruleFirstFacetKey
				{
					...
					set(
						...
						"firstFacet",
						lv_firstFacet_1_0,
						"ummisco.gama.Gaml.FirstFacetKey");
					afterParserOrEnumRuleCall();
				}
			)
		)?
				...
				(
					...
					lv_args_4_0=ruleActionArguments
					{
						...
						set(
							...
							"args",
							lv_args_4_0,
							"ummisco.gama.Gaml.ActionArguments");
						afterParserOrEnumRuleCall();
					}
				)
			)
			...
			(
				...
				lv_key_1_0=rule_VarOrConstKey
				{
					...
					set(
						...
						"key",
						lv_key_1_0,
						"ummisco.gama.Gaml._VarOrConstKey");
					afterParserOrEnumRuleCall();
				}
			)
		)
				...
				(
					...
					lv_key_1_0=rule_AssignmentKey
					{
						...
						set(
							...
							"key",
							lv_key_1_0,
							"ummisco.gama.Gaml._AssignmentKey");
						afterParserOrEnumRuleCall();
					}
				)
			)
			...
			(
				...
				lv_key_0_0=rule_EquationsKey
				{
					...
					set(
						...
						"key",
						lv_key_0_0,
						"ummisco.gama.Gaml._EquationsKey");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_block_4_0=ruledisplayBlock
				{
					...
					set(
						...
						"block",
						lv_block_4_0,
						"ummisco.gama.Gaml.displayBlock");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_statements_2_0=ruledisplayStatement
				{
					...
					add(
						...
						"statements",
						lv_statements_2_0,
						"ummisco.gama.Gaml.displayStatement");
					afterParserOrEnumRuleCall();
				}
			)
		)*
			...
			(
				...
				lv_args_0_0=ruleArgumentDefinition
				{
					...
					add(
						...
						"args",
						lv_args_0_0,
						"ummisco.gama.Gaml.ArgumentDefinition");
					afterParserOrEnumRuleCall();
				}
			)
		)
				...
				(
					...
					lv_key_0_0=ruleClassicFacetKey
					{
						...
						set(
							...
							"key",
							lv_key_0_0,
							"ummisco.gama.Gaml.ClassicFacetKey");
						afterParserOrEnumRuleCall();
					}
				)
			)
				...
				(
					...
					lv_key_2_0=ruleSpecialFacetKey
					{
						...
						set(
							...
							"key",
							lv_key_2_0,
							"ummisco.gama.Gaml.SpecialFacetKey");
						afterParserOrEnumRuleCall();
					}
				)
			)
			...
			(
				...
				lv_key_0_0=ruleDefinitionFacetKey
				{
					...
					set(
						...
						"key",
						lv_key_0_0,
						"ummisco.gama.Gaml.DefinitionFacetKey");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_key_0_0=ruleTypeFacetKey
				{
					...
					set(
						...
						"key",
						lv_key_0_0,
						"ummisco.gama.Gaml.TypeFacetKey");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_key_0_0=ruleActionFacetKey
				{
					...
					set(
						...
						"key",
						lv_key_0_0,
						"ummisco.gama.Gaml.ActionFacetKey");
					afterParserOrEnumRuleCall();
				}
			)
		)
				...
				(
					...
					lv_right_3_0=ruleMultiplication
					{
						...
						set(
							...
							"right",
							lv_right_3_0,
							"ummisco.gama.Gaml.Multiplication");
						afterParserOrEnumRuleCall();
					}
				)
			)
				...
				(
					...
					lv_right_3_0=ruleExponentiation
					{
						...
						set(
							...
							"right",
							lv_right_3_0,
							"ummisco.gama.Gaml.Exponentiation");
						afterParserOrEnumRuleCall();
					}
				)
			)
						...
						(
							...
							lv_right_3_0=ruleExpressionList
							{
								...
								set(
									...
									"right",
									lv_right_3_0,
									"ummisco.gama.Gaml.ExpressionList");
								afterParserOrEnumRuleCall();
							}
						)
					)?
							...
							(
								...
								lv_right_6_2=ruleStringLiteral
								{
									...
									set(
										...
										"right",
										lv_right_6_2,
										"ummisco.gama.Gaml.StringLiteral");
									afterParserOrEnumRuleCall();
								}
							)
						)
