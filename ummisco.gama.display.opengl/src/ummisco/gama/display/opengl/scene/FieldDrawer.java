/*******************************************************************************************************
 *
 * ummisco.gama.display.opengl.scene.FieldDrawer.java, in plugin ummisco.gama.display.opengl, is part of the source code
...
public class FieldDrawer extends ObjectDrawer<FieldObject> {
	...
	public BufferedImage getDirectImage(final FieldObject object, final int order) {
		...
		if (t instanceof IGamaFile.Image)
			return ((IGamaFile.Image) t).getImage(null, true);
		return null;
	}
