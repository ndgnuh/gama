...
import ummisco.gama.display.opengl.camera.CameraArcBall;
import ummisco.gama.display.opengl.camera.FreeFlyCamera;
import ummisco.gama.display.opengl.camera.ICamera;
...
public class CameraHelper extends AbstractRendererHelper implements ICamera {
	...
	public GamaPoint getLastMousePressedPosition() {
		if (camera != null)
			return camera.getLastMousePressedPosition();
		return NULL_POINT;
	}

	public void hook() {
		final GLCanvas canvas = (GLCanvas) getCanvas();
