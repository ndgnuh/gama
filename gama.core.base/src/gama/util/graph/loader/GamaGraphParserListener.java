/*******************************************************************************************************
 *
 * gama.util.graph.loader.GamaGraphParserListener.java, in plugin gama.core, is part of the source code of the
...
import gama.runtime.exceptions.PostponedWarningList;
