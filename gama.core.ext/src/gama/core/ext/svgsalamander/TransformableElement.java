...
public class TransformableElement extends SVGElement {
	...
	public TransformableElement(final String id, final SVGElement parent) {
		super(id, parent);
	}
	/*
	 ...
	 *
	 * String transform = attrs.getValue("transform"); if (transform != null) { xform = parseTransform(transform); } }
	 */
	...
	//
	// if (getPres(sty.setName("transform"))) {
	// final AffineTransform newXform = parseTransform(sty.getStringValue());
