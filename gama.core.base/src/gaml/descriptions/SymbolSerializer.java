/*******************************************************************************************************
 *
 * gaml.descriptions.SymbolSerializer.java, in plugin gama.core, is part of the source code of the GAMA modeling
...
public class SymbolSerializer<C extends SymbolDescription> implements IKeyword {
	 ...
	 * Method serialize()
	 *
	 * @see gaml.descriptions.IDescriptionSerializer#serialize(gaml.descriptions.IDescription)
	 */
