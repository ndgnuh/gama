/*********************************************************************************************
 *
 * 'ClassicalSISEquations.java, in plugin ummisco.gama.extensions.maths, is part of the source code of the GAMA modeling
 ...
 *
 **********************************************************************************************/
package ummisco.gama.extensions.maths.ode.utils.classicalEquations.epidemiology;
...
import ummisco.gama.extensions.maths.ode.statements.SingleEquationStatement;
...
public class ClassicalSISEquations {
	...
	public List<SingleEquationStatement> SIS(final IExpression with_vars, final IExpression with_params) {
