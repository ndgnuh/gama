/*********************************************************************************************
 *
 * 'TemplateReferenceMenu.java, in plugin gama.ui.base.modeling, is part of the source code of the GAMA modeling and
...
public class TemplateReferenceMenu extends GamlReferenceMenu {
	...
	public void editTemplate(final String dataId) {
		...
		if (data == null) {
			data = new TemplatePersistenceData(
					new Template("", "", "gama.core.gaml.Gaml.Model", editor.getSelectedText(), true), true,
					dataId);
		}
	...
	protected void openView() {
		try {
			WorkbenchHelper.getPage().showView("gama.core.gaml.ui.templates");
