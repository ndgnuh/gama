/*******************************************************************************************************
 *
 * gama.metamodel.population.MetaPopulation.java, in plugin gama.core, is part of the source code of the GAMA
...
public class MetaPopulation implements IContainer.Addressable<Integer, IAgent>, IPopulationSet {
	 ...
	 * Method first()
	 *
	 * @see gama.common.interfaces.IContainer#first(gama.runtime.scope.IScope)
	 */
	@Override
	 ...
	 * Method last()
	 *
	 * @see gama.common.interfaces.IContainer#last(gama.runtime.scope.IScope)
	 */
	@Override
	 ...
	 * Method any()
	 *
	 * @see gama.common.interfaces.IContainer#any(gama.runtime.scope.IScope)
	 */
	@Override
	 ...
	 * Method matrixValue()
	 *
	 * @see gama.common.interfaces.IContainer#matrixValue(gama.runtime.scope.IScope)
	 */
	@Override
	 ...
	 * Method matrixValue()
	 *
	 * @see gama.common.interfaces.IContainer#matrixValue(gama.runtime.scope.IScope, gama.metamodel.shape.GamaPoint)
	 */
	@Override
	 ...
	 * Method mapValue()
	 *
	 * @see gama.common.interfaces.IContainer#mapValue(gama.runtime.scope.IScope)
	 */
	@Override
	 ...
	 *
	 * @see gama.metamodel.population.IPopulationSet#getPopulations(gama.runtime.scope.IScope)
	 */
	@Override
