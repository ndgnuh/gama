...
import ummisco.gama.generator.GamlGenerator;
import ummisco.gama.parser.antlr.GamlAntlrTokenFileProvider;
import ummisco.gama.parser.antlr.GamlParser;
import ummisco.gama.parser.antlr.internal.InternalGamlLexer;
import ummisco.gama.scoping.GamlScopeProvider;
import ummisco.gama.serializer.GamlSemanticSequencer;
import ummisco.gama.serializer.GamlSyntacticSequencer;
import ummisco.gama.services.GamlGrammarAccess;
import ummisco.gama.validation.GamlConfigurableIssueCodesProvider;
import ummisco.gama.validation.GamlValidator;
...
public abstract class AbstractGamlRuntimeModule extends DefaultRuntimeModule {
	...
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "ummisco/gama/Gaml.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("ummisco.gama.Gaml");
	}
