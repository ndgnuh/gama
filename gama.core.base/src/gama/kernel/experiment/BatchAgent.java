/*******************************************************************************************************
 *
 * gama.kernel.experiment.BatchAgent.java, in plugin gama.core, is part of the source code of the GAMA modeling
...
public class BatchAgent extends ExperimentAgent {
	 ...
	 * Method step()
	 *
	 * @see gama.metamodel.agent.GamlAgent#step(gama.runtime.scope.IScope) This method, called once by the front
