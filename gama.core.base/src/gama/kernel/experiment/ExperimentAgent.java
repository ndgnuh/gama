...
public class ExperimentAgent extends GamlAgent implements IExperimentAgent {
	 ...
	 *
	 * @see gama.metamodel.agent.GamlAgent#_init_(gama.runtime.scope.IScope)
	 */
	@Override
	 ...
	 * Method primDie()
	 *
	 * @see gama.metamodel.agent.MinimalAgent#primDie(gama.runtime.scope.IScope)
	 */
	@Override
	 ...
	 *
	 * @see gama.common.interfaces.experiment.IExperimentAgent#closeSimulation(gama.kernel.simulation.SimulationAgent)
	 */
	@Override
	 ...
	 *
	 * @see gama.common.interfaces.experiment.ITopLevelAgent#getOutputManager()
	 */
	@Override
