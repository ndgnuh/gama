 ...
 * duplicate points. It preserves the order of the input points.
 *
 * @version 1.7
 */
public class UniqueCoordinateArrayFilter implements CoordinateFilter {
	 ...
	 */
	public static Coordinate[] filterCoordinates(final Coordinate[] coords) {
	...
	public Coordinate[] getCoordinates() {
		final Coordinate[] coordinates = new Coordinate[list.size()];
