...
/**
 * A ConnectedElementPointFilter extracts a single point from each connected element in a Geometry (e.g. a polygon,
 * linestring or point) and returns them in a list. The elements of the list are
...
public class ConnectedElementLocationFilter implements GeometryFilter {
	 ...
	 * Thus, if the specified geometry is not a GeometryCollection, an empty list will be returned. The elements of the
	 * list are {@link org.locationtech.jts.operation.distance.GeometryLocation}s.
	 */
