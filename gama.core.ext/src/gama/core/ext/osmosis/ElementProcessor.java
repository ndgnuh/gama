...
/**
 * An element processor provides a handler for processing a specific xml element within a document. It provides a state
 * pattern approach to processing nested xml structures.
 *
