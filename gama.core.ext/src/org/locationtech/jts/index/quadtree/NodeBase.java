...
public abstract class NodeBase implements Serializable {
	 ...
	 *         envelope
	 */
	public static int getSubnodeIndex(final Envelope env, final double centrex, final double centrey) {
		int subnodeIndex = -1;
	...
	public List<Object> addAllItems(final List<Object> resultItems) {
	...
	public void addAllItemsFromOverlapping(final Envelope searchEnv, final List<Object> resultItems) {
	...
	public void visit(final Envelope searchEnv, final ItemVisitor visitor) {
		if (!isSearchMatch(searchEnv)) { return; }
	...
	private void visitItems(final Envelope searchEnv, final ItemVisitor visitor) {
