 ...
 * 
 **********************************************************************************************/
package gama.core.headless.util;
...
public class Constants {
	...
	// Generation folders
	public static String WIKI_FOLDER_REF = WIKI_FOLDER + File.separator + "References" + File.separator
			+ "GAMLReferences";
	...
	// public static String WIKI2WIKI_FOLDER = GEN_FOLDER + File.separator +
	// "wiki2wiki";
	public static String WIKI2HTML_FOLDER = GEN_FOLDER + File.separator + "wiki2html";
	// public static String HTML2XML_FOLDER = GEN_FOLDER + File.separator +
	// "html2xml";
	...
	public static String XSL_XML2KEYWORDS_XML_FOLDER = INPUT_FOLDER + File.separator + "xsl" + File.separator
			+ "xml2keywordsXml";
	...
	// public static String DOCGAMA_FINAL = HTML2XML_FOLDER + File.separator +
	// "docGamaFinal.xml";
