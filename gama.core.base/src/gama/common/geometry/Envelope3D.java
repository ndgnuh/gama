/*******************************************************************************************************
 *
 * gama.common.geometry.Envelope3D.java, in plugin gama.core, is part of the source code of the GAMA modeling
...
public class Envelope3D extends Envelope implements IDisposable {
	...
	public static Envelope3D of(final Coordinate s) {
