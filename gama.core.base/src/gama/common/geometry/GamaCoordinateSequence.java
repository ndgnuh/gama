/*******************************************************************************************************
 *
 * gama.common.geometry.GamaCoordinateSequence.java, in plugin gama.core, is part of the source code of the GAMA
...
import static gama.common.geometry.GamaGeometryFactory.isRing;
...
public class GamaCoordinateSequence implements ICoordinates {
	 ...
	 * (non-Javadoc)
	 *
	 * @see gama.common.util.ICoordinates#yNegated()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 *
	 * @see gama.common.util.ICoordinates#visitConsecutive(gama.common.util.GamaCoordinateSequence.PairVisitor)
	 */
	@Override
	...
	public GamaPoint directionBetweenLastPointAndOrigin() {
		...
		for (int i = points.length - 1; i > 0; i--) {
			if (!points[i].equals(origin)) {
				result.setLocation(points[i]);
				result.subtract(origin).normalize();
				return result;
			}
		}
		return result;
