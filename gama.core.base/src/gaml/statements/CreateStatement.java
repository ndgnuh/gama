/*******************************************************************************************************
 *
 * gaml.statements.CreateStatement.java, in plugin gama.core, is part of the source code of the GAMA modeling
...
import static gama.common.interfaces.IKeyword.CREATE;
import static gama.common.interfaces.IKeyword.FROM;
import static gama.common.interfaces.IKeyword.HEADER;
...
import static gama.processor.annotations.ISymbolKind.SEQUENCE_STATEMENT;
...
import gama.kernel.experiment.ExperimentPlan.ExperimentPopulation;
...
import gaml.statements.CreateStatement.CreateSerializer;
import gaml.statements.CreateStatement.CreateValidator;
