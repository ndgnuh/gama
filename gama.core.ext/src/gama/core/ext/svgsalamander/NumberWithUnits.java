...
public class NumberWithUnits implements Serializable {
	...
	public NumberWithUnits(final String value) {
		set(value);
	}

	public NumberWithUnits(final float value, final int unitType) {
		this.value = value;
	...
	public static String unitsAsString(final int unitIdx) {
		switch (unitIdx) {
	...
	public boolean equals(final Object obj) {
		...
		if (this.unitType != other.unitType) { return false; }
		return true;
	}
