...
public abstract class AbstractNode implements Boundable, Serializable {
	...
	private final ArrayList<Boundable> childBoundables = new ArrayList<>();
	 ...
	 *
	 * @param level
	 *            0 if this node is a leaf, 1 if a parent of a leaf, and so on; the root node will have the highest
	 *            level
	 */
	...
	/**
	 * Returns a representation of space that encloses this Boundable, preferably not much bigger than this Boundable's
	 * boundary yet fast to test for intersection with the bounds of other Boundables. The class of object returned
	 * depends on the subclass of AbstractSTRtree.
	 *
	 * @return an Envelope (for STRtrees), an Interval (for SIRtrees), or other object (for other subclasses of
	 *         AbstractSTRtree)
