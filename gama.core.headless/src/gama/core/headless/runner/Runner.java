package gama.core.headless.runner;
...
public class Runner {
	...
	public void extractZip(final String path) {
	...
	public static void unzip(final String zipFile, String location) throws IOException {
	...
	public void run(final String path, final String[] args) {
		// String out=console("/Gama/headless/gama-headless.sh samples/predatorPrey.xml o", "/");
		String os = System.getProperty("os.name");

		// String fscript = os.startsWith("Win") ? path + "\\headless\\gama-headless.bat" : path +
