/*******************************************************************************************************
 *
 * gaml.descriptions.IDescription.java, in plugin gama.core, is part of the source code of the GAMA modeling and
...
import gaml.descriptions.SymbolSerializer.ModelSerializer;
import gaml.descriptions.SymbolSerializer.SpeciesSerializer;
...
public interface IDescription extends IGamlDescription, IKeyword, ITyped, IDisposable, IVarDescriptionProvider,
	 ...
	 * (non-Javadoc)
	 *
	 * @see gama.common.interfaces.IBenchmarkable#getNameForBenchmarks()
	 */
	@Override
