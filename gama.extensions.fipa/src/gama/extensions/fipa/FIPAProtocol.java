/*******************************************************************************************************
 *
 * gama.extensions.fipa.FIPAProtocol.java, in plugin gama.extensions.fipa, is part of the source code of the
...
import static gama.extensions.fipa.Performative.accept_proposal;
import static gama.extensions.fipa.Performative.agree;
import static gama.extensions.fipa.Performative.cancel;
import static gama.extensions.fipa.Performative.cfp;
import static gama.extensions.fipa.Performative.failure;
import static gama.extensions.fipa.Performative.inform;
import static gama.extensions.fipa.Performative.not_understood;
import static gama.extensions.fipa.Performative.propose;
import static gama.extensions.fipa.Performative.proxy;
import static gama.extensions.fipa.Performative.query;
import static gama.extensions.fipa.Performative.refuse;
import static gama.extensions.fipa.Performative.reject_proposal;
import static gama.extensions.fipa.Performative.request;
import static gama.extensions.fipa.Performative.request_when;
import static gama.extensions.fipa.Performative.subscribe;
