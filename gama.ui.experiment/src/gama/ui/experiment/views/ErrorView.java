/*********************************************************************************************
 *
 * 'ErrorView.java, in plugin gama.ui.experiment.experiment, is part of the source code of the GAMA modeling and simulation
...
public class ErrorView extends ExpandableItemsView<GamaRuntimeException> implements IGamaView.Error {
	...
	private void createStackTrace(final ScrolledComposite compo, final GamaRuntimeException exception) {
		...
		t.setForeground(exception.isWarning() ? GamaColors.get(GamaUIPreferences.WARNING_TEXT_COLOR.getValue()).color()
				: GamaColors.get(GamaUIPreferences.ERROR_TEXT_COLOR.getValue()).color());
