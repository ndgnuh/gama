/*******************************************************************************************************
 *
 * ummisco.gama.outputs.layers.LayerData.java, in plugin msi.gama.core, is part of the source code of the GAMA modeling and
...
public class LayerData extends AttributeHolder implements ILayerData {
	 ...
	 * Method getTrace()
	 *
	 * @see msi.gama.common.interfaces.outputs.ILayerData#getTrace()
	 */
	@Override
	 ...
	 * Method getFading()
	 *
	 * @see msi.gama.common.interfaces.outputs.ILayerData#getFading()
	 */
	@Override
