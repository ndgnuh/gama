package gama.extensions.graph.yifanhu;
...
public class GraphForceAtlasLayoutStatement extends AbstractGraphLayoutStatement {
	...
	protected Object privateExecuteIn(final IScope scope) throws GamaRuntimeException {
		...
		final boolean approximate_repulsion = Cast.asBool(scope, getFacetValue(scope,
				GraphForceAtlasLayoutStatement.APPROXIMATE_REPULSION, APPROXIMATE_REPULSION_DEFAULT));
		final double approximation = Cast.asFloat(scope,
		...
		final Object bp1 = getFacetValue(scope, GraphForceAtlasLayoutStatement.BOUNDED_P1, null);
		final Object bp2 = getFacetValue(scope, GraphForceAtlasLayoutStatement.BOUNDED_P2, null);
