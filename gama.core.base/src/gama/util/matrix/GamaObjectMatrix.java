/*******************************************************************************************************
 *
 * gama.util.matrix.GamaObjectMatrix.java, in plugin gama.core, is part of the source code of the GAMA modeling
...
public class GamaObjectMatrix extends GamaMatrix<Object> {
	 ...
	 * Method iterator()
	 *
	 * @see gama.util.matrix.GamaMatrix#iterator()
	 */
	@Override
	 ...
	 *
	 * @see gama.util.matrix.GamaMatrix#getNthElement(java.lang.Integer)
	 */
	@Override
