...
@lexer::header {
package gama.core.parser.antlr.internal;
...
import gama.core.services.GamlGrammarAccess;
		...
		(
			...
			lv_exp_0_0=ruleHeadlessExperiment
			{
				...
				set(
					...
					"exp",
					lv_exp_0_0,
					"gama.core.Gaml.HeadlessExperiment");
				afterParserOrEnumRuleCall();
			}
		)
	)
			...
			(
				...
				lv_key_0_0=rule_1Expr_Facets_BlockOrEnd_Key
				{
					...
					set(
						...
						"key",
						lv_key_0_0,
						"gama.core.Gaml._1Expr_Facets_BlockOrEnd_Key");
					afterParserOrEnumRuleCall();
				}
			)
		)
				...
				(
					...
					lv_args_4_0=ruleActionArguments
					{
						...
						set(
							...
							"args",
							lv_args_4_0,
							"gama.core.Gaml.ActionArguments");
						afterParserOrEnumRuleCall();
					}
				)
			)
			...
			(
				...
				lv_statements_2_0=ruledisplayStatement
				{
					...
					add(
						...
						"statements",
						lv_statements_2_0,
						"gama.core.Gaml.displayStatement");
					afterParserOrEnumRuleCall();
				}
			)
		)*
			...
			(
				...
				lv_args_0_0=ruleArgumentDefinition
				{
					...
					add(
						...
						"args",
						lv_args_0_0,
						"gama.core.Gaml.ArgumentDefinition");
					afterParserOrEnumRuleCall();
				}
			)
		)
				...
				(
					...
					lv_key_0_0=ruleClassicFacetKey
					{
						...
						set(
							...
							"key",
							lv_key_0_0,
							"gama.core.Gaml.ClassicFacetKey");
						afterParserOrEnumRuleCall();
					}
				)
			)
				...
				(
					...
					lv_key_2_0=ruleSpecialFacetKey
					{
						...
						set(
							...
							"key",
							lv_key_2_0,
							"gama.core.Gaml.SpecialFacetKey");
						afterParserOrEnumRuleCall();
					}
				)
			)
			...
			(
				...
				lv_key_0_0=ruleDefinitionFacetKey
				{
					...
					set(
						...
						"key",
						lv_key_0_0,
						"gama.core.Gaml.DefinitionFacetKey");
					afterParserOrEnumRuleCall();
				}
			)
		)
