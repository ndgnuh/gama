...
public class ExperimentPlan extends GamlSpecies implements IExperimentPlan {
	 ...
	 *
	 * @see gama.common.interfaces.experiment.IExperimentPlan#getController()
	 */
	@Override
	 ...
	 *
	 * @see gama.common.interfaces.experiment.IExperimentPlan#refreshAllOutputs()
	 */
	@Override
	 ...
	 *
	 * @see gama.common.interfaces.experiment.IExperimentPlan#getOriginalSimulationOutputs()
	 */
	@Override
