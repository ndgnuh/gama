 ...
 * <tt>SAXParser</tt>. This class requires the presence of a SAX Parser available via the
 ...
 * <p>
 * It is the caller's responsibility to ensure that the supplied {@link PrecisionModel} matches the precision of the
...
public class GMLReader {
	 ...
	 */
	public Geometry read(final String gml, final GeometryFactory geometryFactory)
	 ...
	 * @throws IOException
	 */
	public Geometry read(final Reader reader, GeometryFactory geometryFactory)
			throws SAXException, IOException, ParserConfigurationException {
		...
		final GMLHandler gh = new GMLHandler(geometryFactory, null);
