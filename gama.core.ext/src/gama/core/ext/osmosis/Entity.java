...
public abstract class Entity implements Storeable {
	 ...
	 */
	@Deprecated
	public Entity(final long id, final int version, final Date timestamp, final OsmUser user, final long changesetId) {
	 ...
	 */
	@Deprecated
	public Entity(final long id, final int version, final TimestampContainer timestampContainer, final OsmUser user,
	 ...
	 */
	protected Entity(final Entity originalEntity) {
	 ...
	 */
	public Entity(final StoreReader sr, final StoreClassRegister scr) {
	...
	/**
	 * Returns a writeable instance of this entity. If the object is read-only a clone is created, if it is already
	 * writeable then this object is returned.
	 *
