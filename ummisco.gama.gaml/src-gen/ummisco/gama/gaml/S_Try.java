 ...
 * </p>
 * <ul>
 *   <li>{@link ummisco.gama.gaml.S_Try#getCatch <em>Catch</em>}</li>
 * </ul>
 *
 * @see ummisco.gama.gaml.GamlPackage#getS_Try()
 * @model
 * @generated
 */
public interface S_Try extends Statement
{
   ...
   * @see #setCatch(Block)
   * @see ummisco.gama.gaml.GamlPackage#getS_Try_Catch()
  ...
  /**
   * Sets the value of the '{@link ummisco.gama.gaml.S_Try#getCatch <em>Catch</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
