/*******************************************************************************************************
 *
 * ummisco.gama.outputs.AbstractOutputManager.java, in plugin msi.gama.core, is part of the source code of the GAMA modeling
...
public abstract class AbstractOutputManager extends Symbol implements IOutputManager {
	...
	public void setLayout(final ISymbol layout) {
		this.layout = layout;
	}

	@Override
	public ISymbol getLayout() {
		return layout;
	}
