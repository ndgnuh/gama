...
call java  -cp %CLASSPATH% -Xms512m -Xmx%memory%  -Djava.awt.headless=true org.eclipse.core.launcher.Main  -application gama.headless.id4 -data "%outputFile%/.work" !param! "%inputFile%" "%outputFile%"
 goto end
