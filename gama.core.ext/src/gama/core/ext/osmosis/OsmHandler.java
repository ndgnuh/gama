...
/**
 * This class is a SAX default handler for processing OSM XML files. It utilises a tree of element processors to extract
 * the data from the xml structure.
 *
...
public class OsmHandler extends DefaultHandler {
	...
	/**
	 * The currently active element processor. This is updated whenever new xml elements are entered or exited.
	 */
	private ElementProcessor elementProcessor;

	/**
	 * Provides location information about the current position in the file which is useful for reporting errors.
	 */
	 ...
	 *            time.
	 */
	public OsmHandler(final Sink osmSink, final boolean enableDateParsing) {
	...
	public void error(final SAXParseException e) throws SAXException {
		LOG.severe("Unable to parse xml file.  publicId=(" + documentLocator.getPublicId() + "), systemId=("
				+ documentLocator.getSystemId() + "), lineNumber=" + documentLocator.getLineNumber() + ", columnNumber="
