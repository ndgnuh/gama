/*******************************************************************************************************
 *
 * gaml.compilation.ast.SyntacticModelElement.java, in plugin gama.core, is part of the source code of the GAMA
...
public class SyntacticModelElement extends SyntacticTopLevelElement {
	...
	public static class SyntacticExperimentModelElement extends SyntacticModelElement {
		 ...
		 * (non-Javadoc)
		 * 
		 * @see gaml.compilation.ast.SyntacticComposedElement#addChild(gaml.compilation.ast.ISyntacticElement)
		 */
		@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see gaml.compilation.ast.SyntacticSpeciesElement#isSpecies()
	 */
	@Override
	 ...
	 * 
	 * @see
	 * gaml.compilation.ast.AbstractSyntacticElement#visitExperiments(gaml.compilation.ast.ISyntacticElement.
	 * SyntacticVisitor)
	 */
	@Override
