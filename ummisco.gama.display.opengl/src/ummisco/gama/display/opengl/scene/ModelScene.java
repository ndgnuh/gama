/*******************************************************************************************************
 *
 * ummisco.gama.display.opengl.scene.ModelScene.java, in plugin ummisco.gama.display.opengl, is part of the source code
...
import ummisco.gama.display.opengl.scene.layers.AxesLayerObject;
import ummisco.gama.display.opengl.scene.layers.FrameLayerObject;
import ummisco.gama.display.opengl.scene.layers.LayerObject;
...
public class ModelScene {
	...
	public void addGeometryFile(final IGamaFile.Geom file, final DrawingAttributes attributes) {
		if (increment()) {
