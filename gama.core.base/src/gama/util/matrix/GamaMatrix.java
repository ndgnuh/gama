/*******************************************************************************************************
 *
 * gama.util.matrix.GamaMatrix.java, in plugin gama.core, is part of the source code of the GAMA modeling and
...
public abstract class GamaMatrix<T> implements IMatrix<T> {
	 ...
	 * (non-Javadoc)
	 *
	 * @see gama.interfaces.IGamaContainer#last()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 *
	 * @see gama.interfaces.IGamaContainer#length()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 *
	 * @see gama.interfaces.IGamaContainer#max()
	 */
	// @Override
	 ...
	 * (non-Javadoc)
	 *
	 * @see gama.interfaces.IGamaContainer#min()
	 */
	// @Override
	...
	// * (non-Javadoc)
	// *
	// * @see gama.interfaces.IGamaContainer#product()
	// */
	// @Override
	...
	// * (non-Javadoc)
	// *
	// * @see gama.interfaces.IGamaContainer#sum()
	// */
	// @Override
	 ...
	 * (non-Javadoc)
	 *
	 * @see gama.interfaces.IGamaContainer#isEmpty()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 *
	 * @see gama.interfaces.IGamaContainer#reverse()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 *
	 * @see gama.interfaces.IValue#listValue(gama.interfaces.IScope)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 *
	 * @see gama.interfaces.IValue#matrixValue(gama.interfaces.IScope, gama.util.GamaPoint)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 *
	 * @see gama.interfaces.IMatrix#getColumnsList()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 *
	 * @see gama.interfaces.IMatrix#plus(gama.interfaces.IMatrix)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 *
	 * @see gama.interfaces.IMatrix#times(gama.interfaces.IMatrix)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 *
	 * @see gama.interfaces.IMatrix#minus(gama.interfaces.IMatrix)
	 */
	@Override
