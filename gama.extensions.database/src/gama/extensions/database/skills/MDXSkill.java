 ...
 *
 *
 * 'MDXSkill.java', in plugin 'gama.extensions.database', is part of the source code of the GAMA modeling and
...
import gama.extensions.database.mdx.MdxConnection;
import gama.extensions.database.mdx.MdxUtils;
