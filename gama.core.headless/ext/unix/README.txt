...
How to start GAMA in headless mode with java command line
    java -cp GAMA_JARS  -Xms512m -Xmx2048 -Djava.awt.headless=true org.eclipse.core.launcher.Main  -application gama.headless.id4 XMLInputFile OutputDirectory

=== Run GAMA headless experiment from Eclipse & GAMA Git Version ===

In the gama.headless plugin, open the plugin.xml file.
...
-v {absolute_path_to_workspace}/gama.headless/ext/unix/samples/predatorPrey.xml {absolute_path_to_workspace}/gama.headless/ext/unix/samples/test
  or 
-v {absolute_path_to_workspace}/gama.headless/ext/unix/samples/roadTraffic.xml {absolute_path_to_workspace}/gama/gama.headless/ext/unix/samples/test
