/*******************************************************************************************************
 *
 * gaml.operators.noisegeneration.ImprovedNoise.java, in plugin gama.core,
 ...
 * 
 ********************************************************************************************************/
package gaml.operators.noisegeneration;

public final class ImprovedNoise {
	static public double noise(final double _x, final double _y, final double _z, final double biais) {
		double x = _x;
		double y = _y;
		double z = _z;
		x = x + biais;
	...
	static double fade(final double t) {
		return t * t * t * (t * (t * 6 - 15) + 10);
	}

	static double lerp(final double t, final double a, final double b) {
		return a + t * (b - a);
	}

	static double grad(final int hash, final double x, final double y, final double z) {
