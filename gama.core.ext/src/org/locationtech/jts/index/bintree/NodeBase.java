...
public abstract class NodeBase {
	...
	public List<Object> addAllItems(final List<Object> items) {
	...
	/**
	 * Adds items in the tree which potentially overlap the query interval to the given collection. If the query
	 * interval is <tt>null</tt>, add all items in the tree.
	 * 
	 * @param interval
	 ...
	 */
	public void addAllItemsFromOverlapping(final Interval interval, final Collection<Object> resultItems) {
