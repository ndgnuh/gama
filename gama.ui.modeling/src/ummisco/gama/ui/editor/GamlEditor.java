/*********************************************************************************************
 *
 * 'GamlEditor.java, in plugin gama.ui.base.modeling, is part of the source code of the GAMA modeling and simulation
...
public class GamlEditor extends XtextEditor implements IGamlBuilderListener, IToolbarDecoratedView {
	...
	public void init(final IEditorSite site, final IEditorInput input) throws PartInitException {
		...
		gama.dev.utils.DEBUG.OUT("init of Editor for " + input.getName());
	...
	public void createPartControl(final Composite compo) {
		gama.dev.utils.DEBUG.OUT("Creating part control of " + this.getPartName());
