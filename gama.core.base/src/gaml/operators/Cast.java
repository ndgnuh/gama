/*******************************************************************************************************
 *
 * gaml.operators.Cast.java, in plugin gama.core, is part of the source code of the GAMA modeling and simulation
 * platform (v. 1.8)
 *
...
import gaml.types.GamaBoolType;
import gaml.types.GamaColorType;
import gaml.types.GamaFloatType;
