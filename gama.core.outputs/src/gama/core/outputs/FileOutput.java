/*******************************************************************************************************
 *
 * gama.core.outputs.FileOutput.java, in plugin msi.gama.core, is part of the source code of the GAMA modeling and
...
public class FileOutput extends AbstractOutput implements IOutput.FileBased {
	 ...
	 * (non-Javadoc)
	 *
	 * @see gama.core.outputs.AbstractOutput#close()
	 */
	@Override
	public void close() {
		switch (type) {
