/*********************************************************************************************
 *
 * 'Main.java, in plugin ummisco.gama.gaml, is part of the source code of the GAMA modeling and simulation platform. (c)
 ...
 *
 **********************************************************************************************/
package ummisco.gama.gaml.generator;
...
public class Main {
	...
	public static void main(final String[] args) {
		...
		final Injector injector = new GamlStandaloneSetupGenerated().createInjectorAndDoEMFRegistration();
