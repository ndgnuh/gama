/*********************************************************************************************
 *
 * 'ApplicationWorkbenchAdvisor.java, in plugin gama.core.application, is part of the source code of the GAMA
...
import gama.core.application.workspace.WorkspaceModelsManager;
...
public class ApplicationWorkbenchAdvisor extends IDEWorkbenchAdvisor {
	...
	public void initialize(final IWorkbenchConfigurer configurer) {
		...
		try {
			...
			dm.setEnabled("gama.core.application.decorator", true);
