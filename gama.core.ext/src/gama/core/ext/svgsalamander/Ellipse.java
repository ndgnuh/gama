...
public class Ellipse extends ShapeElement {
	 ...
	 *
	 * this.cx = parseDouble(cx); this.cy = parseDouble(cy); this.rx = parseDouble(rx); this.ry = parseDouble(ry);
	 *
	 ...
	 *
	 * String cx = attrs.getValue("cx"); String cy = attrs.getValue("cy"); String rx = attrs.getValue("rx"); String ry =
	 * attrs.getValue("ry");
	 *
	 * this.cx = XMLParseUtil.parseDouble(cx); this.cy = XMLParseUtil.parseDouble(cy); this.rx =
	 * XMLParseUtil.parseDouble(rx); this.ry = XMLParseUtil.parseDouble(ry);
	 *
	 * build(); }
	 */
	...
	//
	// if (getPres(sty.setName("cx"))) {
	// final float newCx = sty.getFloatValueWithUnits();
	// if (newCx != cx) {
	// cx = newCx;
	// shapeChange = true;
	// }
	...
	//
	// if (getPres(sty.setName("cy"))) {
	// final float newCy = sty.getFloatValueWithUnits();
	// if (newCy != cy) {
	// cy = newCy;
	// shapeChange = true;
	// }
	...
	//
	// if (getPres(sty.setName("rx"))) {
	// final float newRx = sty.getFloatValueWithUnits();
	// if (newRx != rx) {
	// rx = newRx;
	// shapeChange = true;
	// }
	...
	//
	// if (getPres(sty.setName("ry"))) {
	// final float newRy = sty.getFloatValueWithUnits();
	// if (newRy != ry) {
	// ry = newRy;
	// shapeChange = true;
	// }
