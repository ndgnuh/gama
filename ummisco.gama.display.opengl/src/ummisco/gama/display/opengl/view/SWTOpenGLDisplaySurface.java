/*******************************************************************************************************
 *
 * ummisco.gama.display.opengl.view.SWTOpenGLDisplaySurface.java, in plugin ummisco.gama.display.opengl, is part of the
 ...
 *
 ********************************************************************************************************/
package ummisco.gama.display.opengl.view;
...
import ummisco.gama.display.opengl.renderer.JOGLRenderer;
...
public class SWTOpenGLDisplaySurface implements IDisplaySurface.OpenGL {
	...
	public SWTOpenGLDisplaySurface(final LayeredDisplayOutput objects) {
		output = objects;
