 ...
 * 
 *
 * 'HeadLessErrors.java', in plugin 'gama.core.headless', is part of the source code of the 
...
public abstract class HeadLessErrors {
	...
	private final static String[] ERRORS =
		{
			"Usage:\n\tjava -jar eclipse/plugins/org.eclipse.equinox.launcher_1.2.0.v20110502.jar -console -application gama.core.headless.id4 XMLInputFile XMLOutputFile\n",
