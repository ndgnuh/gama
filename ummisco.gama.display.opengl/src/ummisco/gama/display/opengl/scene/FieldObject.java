/*******************************************************************************************************
 *
 * ummisco.gama.display.opengl.scene.FieldObject.java, in plugin ummisco.gama.display.opengl, is part of the source code of the GAMA
...
public class FieldObject extends AbstractObject<double[], FieldDrawingAttributes> {
	...
	public FieldObject(final double[] dem, final FieldDrawingAttributes attributes) {
		super(dem, attributes, DrawerType.FIELD);
	}
