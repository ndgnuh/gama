...
public class Circle extends ShapeElement {
	 ...
	 *
	 * String cx = attrs.getValue("cx"); String cy = attrs.getValue("cy"); String r = attrs.getValue("r");
	 *
	 * this.cx = XMLParseUtil.parseFloat(cx); this.cy = XMLParseUtil.parseFloat(cy); this.r =
	 * XMLParseUtil.parseFloat(r);
	 *
	 * build();
	 *
