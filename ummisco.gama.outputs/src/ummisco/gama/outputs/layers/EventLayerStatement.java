/*******************************************************************************************************
 *
 * ummisco.gama.outputs.layers.EventLayerStatement.java, in plugin msi.gama.core, is part of the source code of the GAMA
...
import ummisco.gama.outputs.layers.EventLayerStatement.EventLayerValidator;
...
public class EventLayerStatement extends AbstractLayerStatement implements IEventLayerStatement {
	 ...
	 * Method _step()
	 *
	 * @see ummisco.gama.outputs.layers.AbstractLayerStatement#_step(msi.gama.runtime.scope.IScope)
	 */
	@Override
