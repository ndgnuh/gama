...
public interface IDisplayOutput extends IOutput {
	...
	/**
	 * Interface for layered displays
	 *
	 * @author drogoul
	 *
	 */
	public interface Layered extends IDisplayOutput {

		IDisplayData getData();

		Object getImage(int width, int height);

		IDisplaySurface getSurface();

		void setSurface(IDisplaySurface surface);

		IOverlayProvider<IOverlayInfo> getOverlayProvider();

		List<ILayerStatement> getLayers();
