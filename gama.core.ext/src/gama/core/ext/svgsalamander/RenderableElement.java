...
abstract public class RenderableElement extends TransformableElement {
	...
	public RenderableElement(final String id, final SVGElement parent) {
		super(id, parent);
	}
	 ...
	 */
	protected void beginLayer(final Graphics2D g) throws SVGException {
		if (xform != null) {
	 ...
	 */
	protected void finishLayer(final Graphics2D g) {
		if (cachedClip != null) {
