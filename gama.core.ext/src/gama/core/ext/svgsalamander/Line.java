...
public class Line extends ShapeElement {
	 ...
	 *
	 * String x1 = attrs.getValue("x1"); String y1 = attrs.getValue("y1"); String x2 = attrs.getValue("x2"); String y2 =
	 * attrs.getValue("y2");
	 *
	 * this.x1 = XMLParseUtil.parseFloat(x1); this.y1 = XMLParseUtil.parseFloat(y1); this.x2 =
	 * XMLParseUtil.parseFloat(x2); this.y2 = XMLParseUtil.parseFloat(y2);
	 *
	 * build(); }
	 */
	@Override
