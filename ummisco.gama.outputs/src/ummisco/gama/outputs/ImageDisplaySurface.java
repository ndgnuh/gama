/*******************************************************************************************************
 *
 * ummisco.gama.outputs.ImageDisplaySurface.java, in plugin msi.gama.core, is part of the source code of the GAMA
...
public class ImageDisplaySurface implements IDisplaySurface {
	...
	private final IDisplayOutput.Layered output;
	...
	public ImageDisplaySurface(final IDisplayOutput.Layered args) {
		output = args;
		data = output.getData();
	...
	/**
	 * @see msi.gama.common.interfaces.outputs.IDisplaySurface#initialize(double, double, msi.gama.common.interfaces.outputs.IDisplayOutput)
	 */
	@Override
	 ...
	 * Method getData()
	 *
	 * @see msi.gama.common.interfaces.outputs.IDisplaySurface#getData()
	 */
	@Override
	 ...
	 *
	 * @see msi.gama.common.interfaces.outputs.IDisplaySurface#layersChanged()
	 */
	@Override
	 ...
	 * Method changed()
	 *
	 * @see msi.gama.common.interfaces.outputs.IDisplayDataListener#changed(ummisco.gama.outputs.LayeredDisplayData.Changes,
	 *      boolean)
	 */
	@Override
	 ...
	 *
	 * @see msi.gama.common.interfaces.outputs.IDisplaySurface#getVisibleRegionForLayer(msi.gama.common.interfaces.outputs.ILayer)
	 */
	@Override
	 ...
	 * Method isRendered()
	 *
	 * @see msi.gama.common.interfaces.outputs.IDisplaySurface#isRendered()
	 */
	@Override
