/*******************************************************************************************************
 *
 * gama.outputs.IOutputManager.java, in plugin gama.core, is part of the source code of the GAMA modeling and
 ...
 *
 */
public interface IOutputManager extends IStepable, Iterable<IOutput>, ISymbol {

	interface Simulation extends IOutputManager {

		void updateDisplayOutputsName(SimulationAgent simulationAgent);
	}

	interface Experiment extends IOutputManager {

		void setLayout(ISymbol layout);
