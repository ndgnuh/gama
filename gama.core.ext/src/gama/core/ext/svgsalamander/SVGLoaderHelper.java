...
public class SVGLoaderHelper {
	...
	public SVGLoaderHelper(final URI xmlBase, final SVGUniverse universe, final SVGDiagram diagram) {
		/*
		 * URI docURI = null; try { docURI = new URI(docRoot.toString()); } catch (Exception e) { e.printStackTrace(); }
		 */
