...
public class Rect extends ShapeElement {
	 ...
	 *
	 * String x = attrs.getValue("x"); String y = attrs.getValue("y"); String width = attrs.getValue("width"); String
	 * height = attrs.getValue("height"); String rx = attrs.getValue("rx"); String ry = attrs.getValue("ry");
	 *
	 * if (rx == null) rx = ry; if (ry == null) ry = rx;
	 *
	 * this.x = XMLParseUtil.parseFloat(x); this.y = XMLParseUtil.parseFloat(y); this.width =
	 * XMLParseUtil.parseFloat(width); this.height = XMLParseUtil.parseFloat(height); if (rx != null) { this.rx =
