/*******************************************************************************************************
 *
 * ummisco.gama.outputs.display.AWTDisplayGraphics.java, in plugin msi.gama.core, is part of the source code of the GAMA
...
public class AWTDisplayGraphics extends AbstractDisplayGraphics implements PointTransformation {
	 ...
	 * Method is2D()
	 *
	 * @see msi.gama.common.interfaces.outputs.IGraphics#is2D()
	 */
	@Override
	public boolean is2D() {
		return true;
	...
	@Override
	public void beginOverlay(final ILayer.Overlay layer) {
