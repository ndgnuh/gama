/*********************************************************************************************
 *
 * 'SolveStatement.java, in plugin ummisco.gama.extensions.maths, is part of the source code of the GAMA modeling and
 ...
 *
 **********************************************************************************************/
package ummisco.gama.extensions.maths.ode.statements;
...
import ummisco.gama.extensions.maths.ode.statements.SolveStatement.SolveValidator;
import ummisco.gama.extensions.maths.ode.utils.solver.AdamsBashforthSolver;
import ummisco.gama.extensions.maths.ode.utils.solver.AdamsMoultonSolver;
import ummisco.gama.extensions.maths.ode.utils.solver.DormandPrince54Solver;
import ummisco.gama.extensions.maths.ode.utils.solver.DormandPrince853Solver;
import ummisco.gama.extensions.maths.ode.utils.solver.EulerSolver;
import ummisco.gama.extensions.maths.ode.utils.solver.GillSolver;
import ummisco.gama.extensions.maths.ode.utils.solver.GraggBulirschStoerSolver;
import ummisco.gama.extensions.maths.ode.utils.solver.HighamHall54Solver;
import ummisco.gama.extensions.maths.ode.utils.solver.LutherSolver;
import ummisco.gama.extensions.maths.ode.utils.solver.MidpointSolver;
import ummisco.gama.extensions.maths.ode.utils.solver.Rk4Solver;
import ummisco.gama.extensions.maths.ode.utils.solver.Solver;
import ummisco.gama.extensions.maths.ode.utils.solver.ThreeEighthesSolver;
	...
	public static class SolveValidator implements IDescriptionValidator<IDescription> {
		...
		public void validate(final IDescription desc) {
			...
			if (integratedValues != null) {
				desc.warning(
						"This facet is deprecated and be removed soon, please use bracket notation instead, i.e S[], I[]",
						IGamlIssue.GENERAL);
			}
