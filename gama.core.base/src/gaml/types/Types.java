/*******************************************************************************************************
 *
 * gaml.types.Types.java, in plugin gama.core, is part of the source code of the GAMA modeling and simulation
 * platform (v. 1.8)
 *
	...
	public static boolean isEmpty(final IExpression expr2) {
		switch (expr2.getGamlType().getGamlType().id()) {
			case IType.LIST:
				...
				break;
			case IType.MAP:
				if (expr2 instanceof MapExpression)
					return ((MapExpression) expr2).isEmpty();
		}
		return false;
	}
