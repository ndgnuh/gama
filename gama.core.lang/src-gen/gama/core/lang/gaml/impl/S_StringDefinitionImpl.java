 ...
 * </p>
 * <ul>
 *   <li>{@link gama.core.lang.gaml.impl.S_StringDefinitionImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class S_StringDefinitionImpl extends S_DeclarationImpl implements S_StringDefinition
{
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, GamlPackage.SSTRING_DEFINITION__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case GamlPackage.SSTRING_DEFINITION__NAME:
        return getName();
    }
  ...
  public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass)
  {
    if (baseClass == GamlDefinition.class)
    {
      ...
      {
        case GamlPackage.SSTRING_DEFINITION__NAME: return GamlPackage.GAML_DEFINITION__NAME;
        default: return -1;
      }
    }
  ...
  public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass)
  {
    if (baseClass == GamlDefinition.class)
    {
      ...
      {
        case GamlPackage.GAML_DEFINITION__NAME: return GamlPackage.SSTRING_DEFINITION__NAME;
        default: return -1;
      }
    }
