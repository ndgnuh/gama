/*******************************************************************************************************
 *
 * gaml.statements.UsingStatement.java, in plugin gama.core,
...
public class UsingStatement extends AbstractStatementSequence {
	 ...
	 * 
	 * @see gaml.statements.AbstractStatementSequence#enterScope(gama.runtime.scope.IScope)
	 */
	@Override
	 ...
	 * previous one.
	 * 
	 * @see gaml.statements.AbstractStatementSequence#leaveScope(gama.runtime.scope.IScope)
	 */
