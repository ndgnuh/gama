 ...
 *
 **********************************************************************************************/
package ummisco.gama.ui.editor;
...
import ummisco.gama.ui.editbox.BoxProvider;
import ummisco.gama.ui.editbox.BoxProviderRegistry;
import ummisco.gama.ui.editor.toolbar.CreateExperimentSelectionListener;
import ummisco.gama.ui.editor.toolbar.EditorSearchControls;
import ummisco.gama.ui.editor.toolbar.EditorToolbar;
import ummisco.gama.ui.editor.toolbar.GamlQuickOutlinePopup;
import ummisco.gama.ui.editor.toolbar.OpenExperimentSelectionListener;
import ummisco.gama.ui.editor.toolbar.OpenImportedErrorSelectionListener;
import ummisco.gama.ui.editor.toolbar.RevalidateModelSelectionListener;
import ummisco.gama.ui.resources.GamaColors;
import ummisco.gama.ui.resources.GamaColors.GamaUIColor;
import ummisco.gama.ui.templates.GamlEditTemplateDialog;
import ummisco.gama.ui.templates.GamlEditTemplateDialogFactory;
...
import ummisco.gama.validation.IGamlBuilderListener;
...
public class GamlEditor extends XtextEditor implements IGamlBuilderListener, IToolbarDecoratedView {
	...
	protected void handleCursorPositionChanged() {
		if (getSelectionProvider() == null)
			return;
		if (getInternalSourceViewer() == null)
			return;
		if (getInternalSourceViewer().getControl() == null)
			return;
		if (getInternalSourceViewer().getControl().isDisposed())
			return;
	...
	private void beforeSave() {
		if (!GamaPreferences.Modeling.EDITOR_CLEAN_UP.getValue())
			return;
	...
	/**
	 * @see ummisco.gama.gaml.ui.editbox.IBoxEnabledEditor#getDecorator()
	 */
	...
	/**
	 * @see ummisco.gama.gaml.ui.editbox.IBoxEnabledEditor#createDecorator(ummisco.gama.gaml.ui.editbox.IBoxProvider)
	 */
	...
	/**
	 * @see ummisco.gama.gaml.ui.editbox.IBoxEnabledEditor#decorate()
	 */
	...
	/**
	 * @see ummisco.gama.gaml.ui.editor.IGamlEditor#openEditTemplateDialog()
	 */
	...
	/**
	 * @see ummisco.gama.gaml.ui.editor.IGamlEditor#getNewTemplateId(java.lang.String)
	 */
	...
	/**
	 * @see ummisco.gama.gaml.ui.editor.IGamlEditor#applyTemplate(org.eclipse.jface.text.templates.Template)
	 */
