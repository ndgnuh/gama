/*******************************************************************************************************
 *
 * ummisco.gama.display.opengl.scene.ResourceDrawer.java, in plugin ummisco.gama.display.opengl, is part of the source
...
public class ResourceDrawer extends ObjectDrawer<ResourceObject> {
	...
	protected void _draw(final ResourceObject object) {
		...
		try {
			...
			final IGamaFile.Geom file = object.getObject();
			if (file != null) {
