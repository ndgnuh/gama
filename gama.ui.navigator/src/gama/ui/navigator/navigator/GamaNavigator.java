/*******************************************************************************************************
 *
 * gama.ui.base.navigator.GamaNavigator.java, in plugin gama.ui.base.navigator, is part of the source code of the
 ...
 *
 ********************************************************************************************************/
package gama.ui.navigator.navigator;

import static gama.ui.navigator.navigator.contents.NavigatorRoot.getInstance;
...
import gama.ui.navigator.navigator.contents.Tag;
import gama.ui.navigator.navigator.contents.TopLevelFolder;
import gama.ui.navigator.navigator.contents.VirtualContent;
import gama.ui.navigator.navigator.contents.WrappedContainer;
import gama.ui.navigator.navigator.contents.WrappedFile;
import gama.ui.navigator.navigator.contents.WrappedResource;
import gama.ui.navigator.navigator.contents.WrappedSyntacticContent;
...
public class GamaNavigator extends CommonNavigator implements IToolbarDecoratedView, ISelectionChangedListener {
	...
	public void createPartControl(final Composite compo) {
		...
		try {
			...
			mgr.setEnabled("gama.core.application.date.decorator", false);
	...
	final GamaCommand byDate = new GamaCommand("action.toolbar.sort2", "", "Sort by modification date", trigger -> {
		...
		try {
			final IDecoratorManager mgr = PlatformUI.getWorkbench().getDecoratorManager();
			mgr.setEnabled("gama.core.application.date.decorator", enabled);
		} catch (final CoreException e) {
			e.printStackTrace();
		}
