 ...
 *
 ********************************************************************************************************/
package gama.extensions.graph.util;
...
public class GraphUtilsPrefuse {
	...
	public static Graph getPrefuseGraphFromGamaGraphForVisu(final IScope scope, final GamaGraph<?, ?> graph) {
		...
		System.err.println("translation of the graph to a gama.extensions.graph graph...");
		...
		if (graph._internalVertexMap().size() != g.getNodeCount()) {
			throw GamaRuntimeException.error(
					"error during the translation of a Gama graph to a gama.extensions.graph graph: the number of nodes is not the same.",
					scope);
		}
